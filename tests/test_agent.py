"""
Unit tests for Gong main agent interface.

Tests the high-level agent functionality including orchestration,
performance validation, and comprehensive workflow with mock data.
"""
