"""
Gong Navigation Regression Test

Fast, reliable, self-terminating test for Gong navigation functionality.
Designed for CI/CD integration with strict timing and success criteria.

Success Criteria:
- Completes in <30 seconds
- Self-terminates on success or failure  
- Detects Gong URLs (contains 'gong.io')
- Captures authentication tokens (>0 tokens)
