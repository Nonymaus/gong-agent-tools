...
Dependencies:
- Requires: json, logging, pytest, datetime, pathlib
- Used By: 
...
#!/usr/bin/env python3
"""
Gong Real Data Validation Integration Test
...
This version is designed to integrate with the existing test framework and can be
...
class TestGongRealDataValidation:
    ...
    def load_ground_truth_call_data(self, validation_dir: Path) -> Dict[str, Any]:
        ...
        call_data_dir = validation_dir / "call_salesforce"
        call_data = {}
    ...
    def load_ground_truth_email_data(self, validation_dir: Path) -> List[Dict[str, Any]]:
        ...
        email_data_dir = validation_dir / "emails_salesforce"
        emails = []
